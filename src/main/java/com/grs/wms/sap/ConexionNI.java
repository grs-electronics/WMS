...
public class ConexionNI {
	private ICompany company;
	private IRecordset recordSet;
	private static ConexionNI instancia=null;
	public static synchronized ConexionNI getInstancia(){
		return (instancia==null)? new ConexionNI():instancia;
	}
	public ConexionNI(){
